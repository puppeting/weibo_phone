...
public class DanMuDialog extends Dialog {
    ...
    public DanMuDialog(Context context, int  threm ){
        super(context,threm);
    ...
    protected DanMuDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    private void initView() {
        View view = LayoutInflater.from(context).inflate(R.layout.danmu_pop_layout, null, false);
        setContentView(view);
