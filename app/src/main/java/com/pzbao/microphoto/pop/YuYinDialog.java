...
public class YuYinDialog extends Dialog {
    ...
    public YuYinDialog(Context context, int  threm ){
        super(context,threm);
    ...
    protected YuYinDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    private void initView() {
        View view = LayoutInflater.from(context).inflate(R.layout.yuyin_pop_layout, null, false);
        setContentView(view);
