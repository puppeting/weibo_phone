...
public class OpenSuccessDialog extends Dialog {
    ...
    public OpenSuccessDialog(Context context, int  threm ){
        super(context,threm);
    ...
    protected OpenSuccessDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    private void initView() {
        View view = LayoutInflater.from(context).inflate(R.layout.open_item, null, false);
        setContentView(view);
