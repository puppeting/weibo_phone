...
/**
 * */
public class ZhiBoJianDialog extends Dialog {
     private Context context;


    public ZhiBoJianDialog(Context context, int  threm ){
        super(context,threm);
    ...
    protected ZhiBoJianDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    private void initView() {
        View view = LayoutInflater.from(context).inflate(R.layout.zhibo_pop_layout, null, false);
        setContentView(view);
...
//        llTongYi.setText("去阅读");
        findViewById(R.id.tv_ok).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SZWUtils.INSTANCE.showSnakeBarMsg("设置成功");
                dismiss();
            }
        });
    }
