...
/**
 * */
public class TuiLiuDialog extends Dialog {
     private Context context;


    public TuiLiuDialog(Context context, int  threm ){
        super(context,threm);
    ...
    protected TuiLiuDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    private void initView() {
        View view = LayoutInflater.from(context).inflate(R.layout.tuiliu_pop_layout, null, false);
        setContentView(view);
