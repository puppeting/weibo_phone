...
/**
 * */
public class LaLiuDialog extends Dialog {
     private Context context;


    public LaLiuDialog(Context context, int  threm ){
        super(context,threm);
    ...
    protected LaLiuDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    private void initView() {
        View view = LayoutInflater.from(context).inflate(R.layout.laliu_pop_layout, null, false);
        setContentView(view);
