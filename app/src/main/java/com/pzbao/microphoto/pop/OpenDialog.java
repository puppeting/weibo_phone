...
public class OpenDialog extends Dialog {
    ...
    public OpenDialog(Context context, int  threm ){
        super(context,threm);
    ...
    protected OpenDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    private void initView() {
        View view = LayoutInflater.from(context).inflate(R.layout.ts_item, null, false);
        setContentView(view);
...
//        llTongYi.setText("去阅读");
        findViewById(R.id.tv_jujue).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OpenSuccessDialog mdialog = new OpenSuccessDialog(context, R.style.MyDialogStyle);
                mdialog.show();
                dismiss();
            }
        });
        findViewById(R.id.tv_tongyi).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
